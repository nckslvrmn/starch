...
Rectangle {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            property bool hovered: loginMouse.containsMouse
            property bool pressed: loginMouse.pressed

            color: pressed ? accentHov
                 : (hovered || activeFocus) ? accentHov
                 : accent
            border.color: color
            border.width: s * 1
    ...
    Row {
        ...
        Rectangle {
            ...
            property bool hovered: rebootMouse.containsMouse
            property bool pressed: rebootMouse.pressed

            color: pressed ? "#252525"
                 : (hovered || activeFocus) ? "#222222"
                 : surface
            border.color: (hovered || activeFocus) ? "#444444" : borderCol
            border.width: s * 1
        ...
        Rectangle {
            ...
            property bool hovered: shutdownMouse.containsMouse
            property bool pressed: shutdownMouse.pressed
